	...
	<footer class="gappp position-relative mt-3 footer-one no-bottom green-overlay">
			...
			<div class="copy-right">
				...
				<div class="social">
					...
					<ul class="social-medias">
						...
						<li><a href="#"><i class="fa fa-telegram"></i></li>
				...
				<div class="footer-rights">
					...
					<p class="text-white">© Copyright <span> <?php echo date('Y') ; ?> KDC Love Embassy Church</span>. All Rights Reserved.</p>
...
<!--<script src="visual-percent-preloader/percent-preloader.js"></script>-->
